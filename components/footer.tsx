    ...
    <footer className="border-t border-border bg-card">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Expert Shopify developer specializing in custom themes, apps, and extensions.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li className="text-muted-foreground">Theme Development</li>
              <li className="text-muted-foreground">App Development</li>
              <li className="text-muted-foreground">Extensions</li>
        ...
        <div className="pt-8 border-t border-border text-center text-sm text-muted-foreground">
          <p>© {new Date().getFullYear()} Shopify Developer Portfolio. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
